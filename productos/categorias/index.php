...
<body>
    ...
    <div class="velo-negro">
        ...
        <div class="sidebar">
            <aside class="categoria"><a>Categoria</a>
                <ul>
                    <li><input type="checkbox">Laptops</input></li>
                    <li><input type="checkbox">Pc Completa</input></li>
                    <li><input type="checkbox">Monitores</input></li>
                    <li><input type="checkbox">Perifericos</input></li>
                </ul>
            </aside>
        ...
        <div class="contenedor">
            ...
            <div class="productos">
                <?php
                $sentencia = $pdo->prepare("SELECT * FROM `producto` WHERE Tipo = 'categoria'");
                $sentencia->execute();
